...
- **Управление вентиляторами.** «Авто», «Макс.», фиксированная скорость для каждого вентилятора или температурные кривые, которые вы рисуете сами.
- **Безопасность по умолчанию.** При аварийной температуре вентиляторы переходят на полную скорость, а если датчик или OpenSense перестаёт работать, управление снова берёт на себя прошивка.
...
Ноутбуки Acer с игровым интерфейсом прошивки, которым пользуются NitroSense и PredatorSense. OpenSense разрабатывается на **Nitro 5 AN515-57**.

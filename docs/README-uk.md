...
- **Керування вентиляторами.** «Авто», яке OpenSense прискорює під час нагрівання (це можна вимкнути), «Макс.» або «Вручну»: додаткова швидкість для кожного вентилятора, фіксована або за кривою, яку ви малюєте самі.
